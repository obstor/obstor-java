...
import net.obstor.admin.Status;
import net.obstor.admin.UserInfo;
...
public class TestObstorAdminClient extends TestArgs {
  private ObstorAdminClient client;
  ...
  public TestObstorAdminClient(TestArgs args, ObstorAdminClient client) {
    super(args);
    this.client = client;
  }
