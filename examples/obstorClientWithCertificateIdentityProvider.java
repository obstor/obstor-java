...
import net.obstor.credentials.CertificateIdentityProvider;
import net.obstor.credentials.Provider;
import net.obstor.errors.ObstorException;
import javax.net.ssl.SSLSocketFactory;
import javax.net.ssl.X509TrustManager;

public class ObstorClientWithCertificateIdentityProvider {
  public static void main(String[] args) throws ObstorException {
    ...
    // certificates (server and client) used in a Obstor server setup.
    //
    // CertificateFactory certificateFactory = CertificateFactory.getInstance("X.509");
    //
    // Certificate serverCertificate = null;
    // try (FileInputStream fis =
    //     Files.newInputStream(Paths.get("/home/matt/.obstor/certs/public.crt"))) {
    ...
    //     new String(
    //             Files.readAllBytes(Paths.get("/home/matt/.obstor/certs/CAs/client1.key")),
    ...
    // try (FileInputStream fis =
    //     Files.newInputStream(Paths.get("/home/matt/.obstor/certs/CAs/client1.crt"))) {
