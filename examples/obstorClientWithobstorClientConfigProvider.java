...
import net.obstor.credentials.ObstorClientConfigProvider;
import net.obstor.credentials.Provider;
import net.obstor.errors.ObstorException;

public class ObstorClientWithObstorClientConfigProvider {
  public static void main(String[] args) throws ObstorException {
    Provider provider = new ObstorClientConfigProvider(null, null);
