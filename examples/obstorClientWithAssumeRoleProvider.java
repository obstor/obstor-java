...
import net.obstor.credentials.AssumeRoleProvider;
import net.obstor.credentials.Provider;
import net.obstor.errors.ObstorException;

public class ObstorClientWithAssumeRoleProvider {
  public static void main(String[] args) throws ObstorException {
    Provider provider =
        new AssumeRoleProvider(
            "https://demo.obstor.net:9000/", // STS endpoint usually point to Obstor server.
            "obstor", // Access key.
            "obstor123", // Secret key.
