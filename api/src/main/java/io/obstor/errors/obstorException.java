...
/** Base Exception class for all obstor-java exceptions. */
public class ObstorException extends Exception {
  private static final long serialVersionUID = -7241010318779326306L;

  String httpTrace = null;

  /** Constructs a new ObstorException with given error message. */
  public ObstorException(String message) {
    super(message);
  }

  /** Constructs a new ObstorException with given error message. */
  public ObstorException(String message, String httpTrace) {
    super(message);
    this.httpTrace = httpTrace;
  }

  /** Constructs a new ObstorException with the specified detail message and cause. */
  public ObstorException(String message, Throwable cause) {
    super(message, cause);
  }

  /** Constructs a new ObstorException with the specified cause. */
  public ObstorException(Throwable cause) {
    super(cause);
  }
  ...
  public void throwEncapsulatedException()
      throws BucketPolicyTooLargeException, CertificateException, EOFException,
          ...
          JsonProcessingException, KeyManagementException, KeyStoreException, ObstorException,
          NoSuchAlgorithmException, ServerException, XmlParserException {
    Throwable e = getCause();

    // Inherited by ObstorException
