...
public class ReplicationConfiguration {
  ...
  public ReplicationConfiguration(
    ...
    this.role = role; // Role is not applicable in Obstor server and it is optional.
  ...
  public static class Rule {
    ...
    private DeleteReplication deleteReplication; // This is Obstor specific extension.
  ...
  /** Delete replication (Obstor extension) information of {@link ReplicationConfiguration.Rule}. */
