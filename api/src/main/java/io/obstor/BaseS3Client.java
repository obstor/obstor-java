...
import net.obstor.errors.InternalException;
import net.obstor.errors.InvalidResponseException;
import net.obstor.errors.ObstorException;
import net.obstor.errors.ServerException;
import net.obstor.errors.XmlParserException;
import net.obstor.messages.CompleteMultipartUpload;
import net.obstor.messages.CompleteMultipartUploadResult;
import net.obstor.messages.CopyObjectResult;
import net.obstor.messages.CopyPartResult;
import net.obstor.messages.CreateBucketConfiguration;
import net.obstor.messages.DeleteRequest;
import net.obstor.messages.DeleteResult;
import net.obstor.messages.ErrorResponse;
import net.obstor.messages.InitiateMultipartUploadResult;
...
import net.obstor.messages.ListMultipartUploadsResult;
import net.obstor.messages.ListPartsResult;
import net.obstor.messages.ListVersionsResult;
import net.obstor.messages.LocationConstraint;
...
public abstract class BaseS3Client implements AutoCloseable {
  ...
  public CompletableFuture<GenericResponse> createBucket(CreateBucketArgs args) {
    ...
    if (args.forceCreate()) headers.put("x-obstor-force-create", "true");
