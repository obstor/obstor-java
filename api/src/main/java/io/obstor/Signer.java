...
public class Signer {
  ...
  private void setCanonicalQueryString() {
    ...
    // until Obstor server supports it.
  ...
  private void setCanonicalRequest() throws ObstorException {
  ...
  private void setChunkStringToSign() throws ObstorException {
    this.stringToSign =
  ...
  private void setSigningKey(String serviceName) throws ObstorException {
  ...
  private void setSignature() throws ObstorException {
  ...
  private void setPresignCanonicalRequest(int expires) throws ObstorException {
  ...
  public static byte[] sumHmac(byte[] key, byte[] data) throws ObstorException {
    try {
