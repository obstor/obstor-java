...
public class Checksum {
  ...
  public static Map<Algorithm, Hasher> newHasherMap(Algorithm[] algorithms) throws ObstorException {
  ...
  private static void update(
    ...
    while (bytesRead != size) {
      try {
        ...
        if (n < 0) throw new ObstorException("unexpected EOF");
        if (n != 0) {
          bytesRead += n;
  ...
  public static enum Algorithm {
    ...
    public Hasher hasher() throws ObstorException {
  ...
  /** CRC64NVME {@link Hasher} copied from https://github.com/obstor/crc64nvme. */
  ...
  public static class SHA1 implements Hasher {
    ...
    public SHA1() throws ObstorException {
      try {
  ...
  public static class SHA256 implements Hasher {
    ...
    public SHA256() throws ObstorException {
      try {
    ...
    public static byte[] sum(byte[] b, int off, int len) throws ObstorException {
      SHA256 sha256 = new SHA256();
      sha256.update(b, off, len);
      return sha256.sum();
    }

    public static byte[] sum(byte[] b) throws ObstorException {
      return sum(b, 0, b.length);
    }

    public static byte[] sum(String value) throws ObstorException {
  ...
  public static class MD5 implements Hasher {
    ...
    public MD5() throws ObstorException {
      try {
