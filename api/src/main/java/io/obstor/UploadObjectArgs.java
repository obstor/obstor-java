...
/** Arguments of {@link ObstorAsyncClient#uploadObject} and {@link ObstorClient#uploadObject}. */
public class UploadObjectArgs extends PutObjectBaseArgs {
  ...
  public static final class Builder extends PutObjectBaseArgs.Builder<Builder, UploadObjectArgs> {
    ...
    public Builder filename(String filename, long partSize) throws ObstorException {
      try {
    ...
    public Builder filename(String filename) throws ObstorException {
