...
import net.obstor.messages.Progress;
...
public class SelectResponseStream extends InputStream {
  ...
  private boolean populate() throws EOFException, IOException, InternalException, ObstorException {
