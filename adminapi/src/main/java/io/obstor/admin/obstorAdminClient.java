...
import net.obstor.Signer;
import net.obstor.Time;
import net.obstor.Utils;
...
public class ObstorAdminClient {
  ...
  private Credentials getCredentials() throws ObstorException {
    Credentials creds = provider.fetch();
    if (creds == null) throw new ObstorException("Credential provider returns null credential");
    return creds;
  }
  ...
  private Response httpExecute(
      ...
      throws IOException, ObstorException {
    ...
    HttpUrl.Builder urlBuilder =
        this.baseUrl
            ...
            .addEncodedPathSegments(Utils.encodePath("obstor/admin/v3/" + command.toString()));
    ...
    throw new ObstorException("Request failed with response: " + response.body().string());
  }
  ...
  /**
   * Obtains user info for a specified Obstor user.
   *
   * @param accessKey Access Key.
   * @return {@link UserInfo} - user info for the specified accessKey.
   * @throws ObstorException thrown to indicate SDK exception.
   */
  public UserInfo getUserInfo(String accessKey) throws ObstorException {
    try (Response response =
        execute(
            Http.Method.GET,
            Command.USER_INFO,
  ...
  /**
   * Obtains a list of all Obstor users.
   *
   * @return {@link Map<String, UserInfo>} - List of all users.
   * @throws ObstorException thrown to indicate SDK exception.
   */
  public Map<String, UserInfo> listUsers() throws ObstorException {
   ...
   * @throws ObstorException thrown to indicate SDK exception.
   */
  public void deleteUser(@Nonnull String accessKey) throws ObstorException {
    if (accessKey == null || accessKey.isEmpty()) {
      throw new IllegalArgumentException("access key must be provided");
    }
  ...
  /**
   * Obtains group info for a specified Obstor group.
   *
   * @param group Group name.
   * @return {@link GetGroupInfoResponse} - group info for the specified group.
   * @throws ObstorException thrown to indicate SDK exception.
   */
  public GetGroupInfoResponse getGroupInfo(String group) throws ObstorException {
    try (Response response =
  ...
  /**
   * Obtains a list of all Obstor groups.
   *
   * @return {@link List<String>} - List of all groups.
   * @throws ObstorException thrown to indicate SDK exception.
   */
  public List<String> listGroups() throws ObstorException {
   ...
   * @throws ObstorException thrown to indicate SDK exception.
   */
  public void removeGroup(@Nonnull String group) throws ObstorException {
    if (group == null || group.isEmpty()) {
      throw new IllegalArgumentException("group must be provided");
    }
   ...
   * @throws ObstorException thrown to indicate SDK exception.
   */
  public long getBucketQuota(String bucketName) throws ObstorException {
    try (Response response =
        execute(
            Http.Method.GET,
   ...
   * @throws ObstorException thrown to indicate SDK exception.
   */
  public void clearBucketQuota(@Nonnull String bucketName) throws ObstorException {
   ...
   * @throws ObstorException thrown to indicate SDK exception.
   */
  public void addCannedPolicy(@Nonnull String name, @Nonnull String policy) throws ObstorException {
   ...
   * @throws ObstorException thrown to indicate SDK exception.
   */
  public Map<String, String> listCannedPolicies() throws ObstorException {
   ...
   * @throws ObstorException thrown to indicate SDK exception.
   */
  public void removeCannedPolicy(@Nonnull String name) throws ObstorException {
    if (name == null || name.isEmpty()) {
      throw new IllegalArgumentException("name must be provided");
    }
   ...
   * @throws ObstorException thrown to indicate SDK exception.
   */
  public GetDataUsageInfoResponse getDataUsageInfo() throws ObstorException {
  ...
  /**
   * Obtains admin info for the Obstor server.
   *
   * @return {@link GetServerInfoResponse}
   * @throws ObstorException thrown to indicate SDK exception.
   */
  public GetServerInfoResponse getServerInfo() throws ObstorException {
   ...
   * @throws ObstorException thrown to indicate SDK exception.
   */
  public void deleteServiceAccount(@Nonnull String accessKey) throws ObstorException {
    if (accessKey == null || accessKey.isEmpty()) {
      throw new IllegalArgumentException("access key must be provided");
    }
  ...
  /**
   * Obtains a list of obstor service account by user name.
   *
   * @param username user name.
   * @return {@link ListServiceAccountResponse} - List of obstor service account.
   * @throws ObstorException thrown to indicate SDK exception.
   */
  ...
  /**
   * Obtains service account info for a specified Obstor user.
   *
   * @param accessKey Access Key.
  ...
  /** Argument builder of {@link ObstorAdminClient}. */
  public static final class Builder {
    ...
    public ObstorAdminClient build() {
      Utils.validateNotNull(baseUrl, "base url");
      Utils.validateNotNull(provider, "credential provider");
      if (httpClient == null) httpClient = Http.newDefaultClient();
      return new ObstorAdminClient(baseUrl, region, provider, httpClient);
    }
  }
}
