 ...
 *
 * @see <a href=
 *     "https://github.com/obstor/madmin-go/blob/main/info-commands.go#L238">heal-commands.go</a>
 */
...
public class GetServerInfoResponse {
  ...
  public static class ServerProperties {
    ...
    @JsonProperty("obstor_env_vars")
    private Map<String, String> obstorEnvVars;
    ...
    public Map<String, String> obstorEnvVars() {
      return Collections.unmodifiableMap(this.obstorEnvVars);
    }
