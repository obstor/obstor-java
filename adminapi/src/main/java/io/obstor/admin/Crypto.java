...
public class Crypto {
  ...
  private static byte[] generateEncryptDecryptAdditionalData(
      boolean encryptFlag, int aeadId, byte[] key, byte[] paddedNonce) throws ObstorException {
    try {
  ...
  public static byte[] encrypt(byte[] payload, String password) throws ObstorException {
  ...
  /** Reader crypts ObstorAdmin API response. */
  public static class DecryptReader {
    ...
    public DecryptReader(InputStream inputStream, byte[] secret) throws ObstorException {
    ...
    private byte[] decrypt(byte[] encryptedData, boolean lastChunk) throws ObstorException {
      this.count++;
      if (lastChunk) {
    ...
    public byte[] readAllBytes() throws ObstorException {
      ByteArrayOutputStream baos = new ByteArrayOutputStream();
      while (!this.eof) {
        try {
  ...
  /** Decrypt data stream. */
  public static byte[] decrypt(InputStream inputStream, String password) throws ObstorException {
